...
function CustomResponse<T = any>(
    ...
    const response: ICustomResponse<T> = { status, message };
...
export class HttpStatus {
    ...
    static ContinueResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.CONTINUE.code, this.CONTINUE.message, data, paging);
    }

    static SwitchingProtocolsResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.SWITCHING_PROTOCOLS.code, this.SWITCHING_PROTOCOLS.message, data, paging);
    }

    static ProcessingResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.PROCESSING.code, this.PROCESSING.message, data, paging);
    }

    static OKResponse(data: any | null =  null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.OK.code, this.OK.message, data, paging);
    }

    static CreatedResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.CREATED.code, this.CREATED.message, data, paging);
    }

    static AcceptedResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.ACCEPTED.code, this.ACCEPTED.message, data, paging);
    }

    static NonAuthoritativeInformationResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.NON_AUTHORITATIVE_INFORMATION.code, this.NON_AUTHORITATIVE_INFORMATION.message, data, paging);
    }

    static NoContentResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.NO_CONTENT.code, this.NO_CONTENT.message, data, paging);
    }

    static ResetContentResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.RESET_CONTENT.code, this.RESET_CONTENT.message, data, paging);
    }

    static PartialContentResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.PARTIAL_CONTENT.code, this.PARTIAL_CONTENT.message, data, paging);
    }

    static MultipleChoicesResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.MULTIPLE_CHOICES.code, this.MULTIPLE_CHOICES.message, data, paging);
    }

    static MovedPermanentlyResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.MOVED_PERMANENTLY.code, this.MOVED_PERMANENTLY.message, data, paging);
    }

    static FoundResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.FOUND.code, this.FOUND.message, data, paging);
    }

    static SeeOtherResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.SEE_OTHER.code, this.SEE_OTHER.message, data, paging);
    }

    static NotModifiedResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.NOT_MODIFIED.code, this.NOT_MODIFIED.message, data, paging);
    }

    static TemporaryRedirectResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.TEMPORARY_REDIRECT.code, this.TEMPORARY_REDIRECT.message, data, paging);
    }

    static PermanentRedirectResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.PERMANENT_REDIRECT.code, this.PERMANENT_REDIRECT.message, data, paging);
    }

    static BadRequestResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.BAD_REQUEST.code, this.BAD_REQUEST.message, data, paging);
    }

    static UnauthorizedResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.UNAUTHORIZED.code, this.UNAUTHORIZED.message, data, paging);
    }

    static PaymentRequiredResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.PAYMENT_REQUIRED.code, this.PAYMENT_REQUIRED.message, data, paging);
    }

    static ForbiddenResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.FORBIDDEN.code, this.FORBIDDEN.message, data, paging);
    }

    static NotFoundResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.NOT_FOUND.code, this.NOT_FOUND.message, data, paging);
    }

    static InternalServerErrorResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.INTERNAL_SERVER_ERROR.code, this.INTERNAL_SERVER_ERROR.message, data, paging);
    }

    static NotImplementedResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.NOT_IMPLEMENTED.code, this.NOT_IMPLEMENTED.message, data, paging);
    }

    static BadGatewayResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.BAD_GATEWAY.code, this.BAD_GATEWAY.message, data, paging);
    }

    static ServiceUnavailableResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
        return CustomResponse(this.SERVICE_UNAVAILABLE.code, this.SERVICE_UNAVAILABLE.message, data, paging);
    }

    static GatewayTimeoutResponse(data: any | null = null, paging: IPaging | null = null): ICustomResponse {
